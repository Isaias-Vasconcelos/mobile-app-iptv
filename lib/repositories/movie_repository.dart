...
class MovieRepository {
  ...
  List<Movies> getAllMoviesSearch(String term) {
    return _movies
        .where((movie) => movie.title.toLowerCase().contains(term.toLowerCase()))
        .toList();
  }
  ...
  List<Movies> getMoviesByGenderSearch(Gender gender, String term){
    return _movies
        .where((movie) => movie.title.toLowerCase().contains(term.toLowerCase()))
        .toList();
  }
